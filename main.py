...
async def save_file_to_db(
    ...
    """Lưu metadata file vào DB và (tuỳ chọn) blob."""
    user = update.effective_user
    message = update.effective_message
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if args:
        ...
        # ---- Xem trực tiếp 1 file (public, không cần approve) ----
        ...
        # ---- Xem thư mục: gửi lần lượt các file ----
    ...
    # /start bình thường (không có deep-link)
    text = (
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.effective_message.reply_text(
        ...
        "🔹 /upload - Nhắc lại cách dùng upload\n\n"
        "📁 THƯ MỤC:\n"
...
async def upload_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.effective_message.reply_text(
        ...
        "📌 Mỗi file gửi xong bot sẽ gửi link cho bạn copy.",
        parse_mode="HTML",
        reply_markup=get_main_keyboard(),
    )
